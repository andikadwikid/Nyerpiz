                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @if ($servis->status == 'pending' && !$servis->tindakan_servis)
                            <div class="card-header-action">
                                <form action="{{ route('user.form.delete', $servis->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ route('user.form.edit', $servis->id) }}" class="btn btn-warning">Edit</a>
                    ...
                    <div class="card-body">
                        ...
                        @if ($servis->tindakan_servis)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{ date('d-m-Y H:i:s', strtotime($servis->tindakan_servis)) }}
                                </div>
                            </div>
                        @endif
